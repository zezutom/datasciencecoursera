...
# Expected output: "The following queries are identical with 'unique(acs$AGEP)': select distinct AGEP from acs"
msg("The following queries are identical with 'unique(acs$AGEP)':", answer3)
